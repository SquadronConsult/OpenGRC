...
export class CatalogRequirement {
  ...
  @Column({ name: 'catalog_control_id', type: 'uuid', nullable: true })
  ...
  @Column({ name: 'source_frr_id', type: 'uuid', nullable: true })
  sourceFrrId: string | null;

  @Column({ name: 'source_ksi_id', type: 'uuid', nullable: true })
